...
#
# The @classmethod decorator is a built-in function decorator. In Python, we use the @classmethod decorator to declare
# a method as a class method.
# The @classmethod decorator is an expression that gets evaluated after our function is defined.

# What is a Decorator in Python?
# A decorator in Python is a design pattern that lets you add new behavior to a function or class method without modifying
# its structure.
...
# class method directly from class, it acts as constructor
