...
# 		d. each object will have its own copy the variable
# 	2. class variable
...
# class variable--> declare it inside the calss (outside of any method) without using any keywords
#
...
# only intance variable--> Instance Method
